  ...
  return (
    <footer className="bg-forest-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold">The Eco Loop</h2>
            </div>
            ...
            <div className="flex space-x-4 pt-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <Facebook className="h-5 w-5 text-forest-100 hover:text-white" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <Twitter className="h-5 w-5 text-forest-100 hover:text-white" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <Instagram className="h-5 w-5 text-forest-100 hover:text-white" />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-forest-100">
              ...
              <p className="flex items-center">
                ...
                <a href="mailto:hello@theecoloop.com" className="hover:text-white transition-colors">
                  hello@theecoloop.com
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-forest-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-forest-100">
            © {new Date().getFullYear()} The Eco Loop. All rights reserved.
          </p>
